...
static const char qt_meta_stringdata_MyTableModel[] = {
    "MyTableModel\0"
};
...
const QMetaObjectExtraData MyTableModel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MyTableModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_MyTableModel,
      qt_meta_data_MyTableModel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MyTableModel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyTableModel))
